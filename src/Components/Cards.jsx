        ...
        <Row className='gap-4'>
          ...
          <Card style={{ width: '19rem', height: '28rem', border: "solid 5px pink" }}>
            <Card.Body>
              ...
              <Button variant="primary" style={{ marginBottom: "50px", marginLeft: "50px", backgroundColor: "pink" }}>
                <h6 style={{ color: "black", fontFamily: "cursive" }}>Add to cart</h6>
              </Button>
            </Card.Body>
          </Card>
          ...
          <Card style={{ width: '19rem', height: '28rem', border: "solid 5px pink" }}>
            <Card.Body>
              ...
              <Card.Title>Card Title</Card.Title>
              <Button variant="primary" style={{ marginTop: "10px", marginLeft: "55px", backgroundColor: "pink" }}>
                <h6 style={{ color: "black", fontFamily: "cursive" }}>Add to cart</h6>
              </Button>
            </Card.Body>
          </Card>
